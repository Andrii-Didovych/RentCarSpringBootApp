...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <%--@elvariable id="drive" type="java"--%>
                <form:form class="form-inline " action="/admin/drive" method="post" modelAttribute="drive">
                    <div class="form-group  mx-sm-3 mb-2">
                        <form:input path="name" class="form-control"  placeholder="Input name"/>
                    </div>
                    <button type="submit" class="btn btn-success mb-2">Save</button>
                    <a href="/admin/drive/cancel" class="btn btn-info mb-2" style="margin-left: 5px; padding-left:6px; padding-right: 6px">Cancel</a>
                </form:form>
            </div>
        </div>
        ...
        <table class="table table-bordered table-dark">
            ...
            <tbody>
                <a:forEach var="drive" items="${drives}">
                    <tr>
                        <td class="text-center">${drive.name}</td>
                        <td class="text-center">
                            <a href="/admin/drive/update/${drive.id}" class="btn btn-warning btn-sm">Update</a>
                            <a href="/admin/drive/delete/${drive.id}" class="btn btn-danger btn-sm">Delete</a>
                        </td>
                    </tr>
                </a:forEach>
            </tbody>
