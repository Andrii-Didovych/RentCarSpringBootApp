...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <form:form class="form-inline " action="/admin/brand" method="post" modelAttribute="brand">
                    ...
                    <a href="/admin/brand/cancel" class="btn btn-info mb-2" style="margin-left: 5px; padding-left:6px; padding-right: 6px">Cancel</a>
                </form:form>
            </div>
        </div>
        ...
        <table class="table table-bordered table-dark">
            ...
            <tbody>
                <a:forEach var="brand" items="${brands}">
                    <tr>
                        <td class="text-center">${brand.name}</td>
                        <td class="text-center">
                            <a href="/admin/brand/update/${brand.id}" class="btn btn-warning btn-sm">Update</a>
                            <a href="/admin/brand/delete/${brand.id}" class="btn btn-danger btn-sm">Delete</a>
                        </td>
                    </tr>
                </a:forEach>
            </tbody>
