...
<body>
    ...
    <div class="container">
        <%--<div class="row">--%>
            <%--<div class="col-12">--%>
                <%--&lt;%&ndash;@elvariable id="model" type=""&ndash;%&gt;--%>
                <%--<form:form class="form-inline " action="/admin/model" method="post" modelAttribute="model" >--%>
                    <%--<div class="form-group  mx-sm-3 mb-2">--%>
                        <%--<form:select path="brand"  items="${brands}" class="form-control" />--%>
                    <%--</div>--%>
                    <%--<div class="form-group  mx-sm-3 mb-2">--%>
                        <%--<form:input path="name" class="form-control"  placeholder="Input model"/>--%>
                    <%--</div>--%>
                    <%--<button type="submit" class="btn btn-success mb-2">Save</button>--%>
                    <%--<a href="/admin/model/cancel" class="btn btn-info mb-2" style="margin-left: 5px; padding-left:6px; padding-right: 6px">Cancel</a>--%>
                <%--</form:form>--%>
            <%--</div>--%>
        <%--</div>--%>
