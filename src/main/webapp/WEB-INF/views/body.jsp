...
<body>
    ...
    <div class="container">
       <div class="row">
           <div class="col-12">
               <%--@elvariable id="body" type="java"--%>
               <form:form class="form-inline " action="/admin/body" method="post" modelAttribute="body">
                   <div class="form-group  mx-sm-3 mb-2">
                       <form:input path="name" class="form-control"  placeholder="Input name"/>
                   </div>
                   <button type="submit" class="btn btn-success mb-2">Save</button>
                   <a href="/admin/body/cancel" class="btn btn-info mb-2" style="margin-left: 5px; padding-left:6px; padding-right: 6px">Cancel</a>
               </form:form>
           </div>
       </div>
        <%--<div class="row">--%>
            <%--<div class="col-12">--%>
                <table class="table table-bordered table-dark">
                    ...
                    <tbody>
                        <a:forEach var="body" items="${bodies}">
                            <tr>
                                <td class="text-center">${body.name}</td>
                                <td class="text-center">
                                    <a href="/admin/body/update/${body.id}" class="btn btn-warning btn-sm">Update</a>
                                    <a href="/admin/body/delete/${body.id}" class="btn btn-danger btn-sm">Delete</a>
                                </td>
                            </tr>
                        </a:forEach>
                    </tbody>
