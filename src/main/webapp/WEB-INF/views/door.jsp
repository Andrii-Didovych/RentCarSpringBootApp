...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <%--@elvariable id="door" type="java"--%>
                <form:form class="form-inline " action="/admin/door" method="post" modelAttribute="door">
                    <div class="form-group  mx-sm-3 mb-2">
                        <form:input path="name" class="form-control"  placeholder="Input name"/>
                    </div>
                    <button type="submit" class="btn btn-success mb-2">Save</button>
                    <a href="/admin/door/cancel" class="btn btn-info mb-2" style="margin-left: 5px; padding-left:6px; padding-right: 6px">Cancel</a>
                </form:form>
            </div>
        </div>
        ...
        <table class="table table-bordered table-dark">
            <thead>
                <tr>
                    <th scope="col" class="text-center">Door</th>
                    <th scope="col" class="text-center">Options</th>
                </tr>
            </thead>
            <tbody>
                <a:forEach var="door" items="${doors}">
                    <tr>
                        <td class="text-center">${door.name}</td>
                        <td class="text-center">
                            <a href="/admin/door/update/${door.id}" class="btn btn-warning btn-sm">Update</a>
                            <a href="/admin/door/delete/${door.id}" class="btn btn-danger btn-sm">Delete</a>
                        </td>
                    </tr>
                </a:forEach>
            </tbody>
